module.exports = {
  ...
  CONNECTORS: JSON.stringify([
    ...
    { id: 'ETHEREUM_TRANSACTION', fieldName: 'ethereumTransaction', name: 'Ethereum Transaction', picture: 'https://www.ethereum.org/images/logos/ETHEREUM-ICON_Black.png', description: 'Execute an action in Real Time every time you receive a transaction on Ethereum' },
