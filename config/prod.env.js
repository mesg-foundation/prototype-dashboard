module.exports = {
  ...
  CONNECTORS: JSON.stringify([
    ...
    { id: 'ETHEREUM_ERC20', fieldName: 'ethereumErc20', name: 'ERC20', picture: 'https://cdn-images-1.medium.com/max/1200/1*FD2cH_XiSw8oIlT2ojfPdQ.png', description: 'Execute an action in Real Time every time an ERC20 token emits an event' },
