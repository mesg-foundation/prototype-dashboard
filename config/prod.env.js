module.exports = {
  ...
  CONNECTORS: JSON.stringify([
    { id: 'ETHEREUM_CONTRACT', fieldName: 'ethereumContract', name: 'Ethereum Contract', picture: 'https://files.graph.cool/cj7ri5z8d0x5m0149sskbwe15/cja9uujqa03sz01337en8xmvl', description: 'Execute an action in Real Time every time this event is triggers from your contract' },
    { id: 'ETHEREUM_TRANSACTION', fieldName: 'ethereumTransaction', name: 'Ethereum Transaction', picture: 'https://files.graph.cool/cj7ri5z8d0x5m0149sskbwe15/cja9uujqa03sz01337en8xmvl', description: 'Execute an action in Real Time every a transaction happen on an Ethereum address' },
